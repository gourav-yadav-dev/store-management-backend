...
import { purchaseItem, purchaseItemByInvoice, lastPurchaseId, AddPurchaseItem ,updateStock} from '../../repositories/purchase.respository.js'
        ...
        if (userid.length > 0) {
            ...
            if (invoiceNumber.length == 0) {
                ...
                if (purchaItem.affectedRows > 0) {
                    ...
                    console.log("hey0")
                    console.log(addPurchaseItems)
                    console.log("hey0")
                    if (addPurchaseItems.affectedRows > 0) {
                   const updateStockValue=  await updateStock(values)
